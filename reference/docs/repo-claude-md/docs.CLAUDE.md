...
You are building the documentation site for the Wraith Protocol — a multichain stealth address platform.

## Source Material

All content exists in `reference/docs/`. Your job is to turn these implementation guides into a polished documentation site for developers.

## Structure

```
docs/
  index.md                      # Landing — what is Wraith, quick start
