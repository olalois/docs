      ...
      <main className="pt-24">
        ...
        <section className="relative min-h-[85vh] flex items-center px-8 md:px-16 overflow-hidden">
          ...
          <div className="absolute inset-0 z-0 opacity-20">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-tertiary/10 blur-[100px]" />
          </div>

          <div className="grid md:grid-cols-2 gap-12 items-center w-full z-10">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-surface-container mb-6 border-l-4 border-tertiary">
                <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-tertiary">Secured via Phala TEE</span>
              </div>
              ...
              <p className="text-lg text-on-surface-variant max-w-lg mb-10 leading-relaxed">
                Deploy private AI agents on Stellar that handle payments through stealth addresses. Every transaction goes to a fresh one-time address — unlinkable, untraceable.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href="https://github.com/truthixify/wraith-stellar"
                  target="_blank"
            ...
            <div className="relative hidden md:block">
              <div className="bg-surface-container p-8 relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_top_right,rgba(221,183,255,0.05),transparent)]" />
                ...
                <div className="space-y-3">
                  <div className="flex gap-4 p-4 bg-surface-container-low">
                    <div className="w-8 h-8 bg-tertiary/20 flex items-center justify-center text-tertiary text-xs font-mono">W</div>
                  ...
                  <div className="flex gap-4 p-4 bg-surface-container-low ml-8">
                    ...
                    <div className="flex-1">
                      <div className="font-mono text-[10px] text-primary/60">send 50 XLM to alice.wraith</div>
                      <div className="font-mono text-[10px] text-tertiary mt-1">→ stealth address generated</div>
                    </div>
                  </div>
                  <div className="flex gap-4 p-4 bg-surface-container-low">
        ...
        <section className="py-24 px-8 md:px-16 bg-surface">
          <div className="mb-16">
            ...
            <p className="text-on-surface-variant max-w-2xl leading-relaxed">
              WRAITH combines TEE hardware security with Stellar's fast ledger to create a privacy layer for AI agent payments.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="md:col-span-2 bg-surface-container p-10 group hover:bg-surface-bright transition-all">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="bg-surface-container-highest px-3 py-1 font-mono text-[10px] text-primary border-l-2 border-primary">ED25519</span>
                <span className="bg-surface-container-highest px-3 py-1 font-mono text-[10px] text-primary border-l-2 border-primary">SOROBAN</span>
              </div>
            </div>
            ...
            <div className="md:col-span-2 bg-surface-container p-10 group hover:bg-surface-bright transition-all relative overflow-hidden">
              ...
              <div className="text-3xl text-tertiary mb-6 font-mono">⬡</div>
              <h3 className="text-xl font-headline font-bold mb-3 uppercase text-tertiary">TEE-Secured Keys</h3>
              <p className="text-on-surface-variant text-sm">Private keys derived inside Intel TDX hardware enclaves via Phala dstack. Never stored, never exported without consent.</p>
            </div>
            ...
            <div className="md:col-span-3 bg-surface-container p-8 flex flex-col md:flex-row items-start md:items-center gap-8 group hover:bg-surface-bright transition-all">
              ...
              <div className="md:w-1/2 w-full bg-surface-container-low p-4 space-y-2">
                <div className="flex justify-between font-mono text-[9px] text-tertiary/60">
        ...
        <section className="py-24 px-8 md:px-16 bg-surface-container-low">
          <div className="text-center mb-20">
            ...
            <p className="text-on-surface-variant max-w-xl mx-auto">Three steps to private AI agent payments on Stellar.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-1">
            {[
              { num: "01", title: "Connect Wallet", desc: "Sign a message with Freighter to prove wallet ownership. Your identity is verified inside the TEE." },
              { num: "02", title: "Create Agent", desc: "Your agent gets its own Stellar wallet, stealth identity, and .wraith name — all derived inside TEE hardware." },
        ...
        <footer className="py-8 px-8 md:px-16 bg-surface-container-lowest border-t border-outline-variant/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-xs text-outline">
              <a href="https://github.com/truthixify/wraith-stellar" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">GitHub</a>
