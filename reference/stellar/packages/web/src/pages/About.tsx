    ...
    <div className="space-y-24">
      <section className="space-y-8">
        ...
        <p className="text-xl text-on-surface leading-relaxed max-w-prose font-light">
          Wraith is a privacy tool for Stellar, using stealth addresses to
        ...
        <div className="grid grid-cols-1 gap-12 text-on-surface-variant">
          ...
          <div className="space-y-6">
            <p className="leading-relaxed">
              Wraith uses Diffie-Hellman key exchanges over ed25519, with
              X25519 conversion for the shared secret. A sender creates an
              obfuscated destination that only the receiver can claim, breaking
              the link between the receiver's public identity and their on-chain
              holdings.
            </p>
            <p className="leading-relaxed">
      ...
      <section className="space-y-12">
        ...
        <div className="space-y-8">
          <p className="leading-relaxed text-on-surface-variant">
            Wraith is built on Soroban, Stellar's smart contract platform. Three
            contracts power the system: a{" "}
            <span className="text-primary">StealthRegistry</span> for on-chain
            meta-address lookup, a{" "}
            <span className="text-primary">StealthAnnouncer</span> that emits
            events for recipient scanning, and a{" "}
            <span className="text-primary">StealthSender</span> that atomically
            transfers funds and announces the payment.
          </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              href="https://stellar.org/learn/fundamentals"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center justify-between p-6 bg-surface-container hover:bg-surface-container-high transition-all duration-150 border border-outline-variant/10"
            >
            ...
            <a
              href="https://stellar.org/blog/developers/x402-http-payments"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center justify-between p-6 bg-surface-container hover:bg-surface-container-high transition-all duration-150 border border-outline-variant/10"
            >
      ...
      <section className="py-16 border-t border-outline-variant/20 flex flex-col items-center text-center space-y-6">
        ...
        <p className="max-w-md text-sm text-outline leading-relaxed uppercase tracking-wider font-headline">
          Wraith provides the tools to exercise that right on Stellar.
        </p>
      </section>
    </div>
  );
